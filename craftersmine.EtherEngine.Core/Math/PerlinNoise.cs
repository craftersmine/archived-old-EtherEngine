/*
//
// Thanks for Perlin noise code to Flafla2
// https://flafla2.github.io/2014/08/09/perlinnoise.html
// https://gist.github.com/Flafla2/1a0b9ebef678bbce3215
// 
// Licensed by Adrian Biagioli (Flafla2) under a Creative Commons Attribution 4.0 International License.
//
...
namespace craftersmine.EtherEngine.Core.Math
{
    public class PerlinNoise
    {
        ...
        public double OctavePerlin(double x, double y, double z, int octaves, double persistence)
        {
            ...
            {
                total += GetNoiseData(x * frequency, y * frequency, z * frequency) * amplitude;
